...
def createPublicHolidays2018():
	...
	newYearsDay = Event(name="New Year's Day", description='The day after the new year.', country='', city='')
	newYearsDayDate.events.append(newYearsDay)

	goodFriDate = Date.query.filter_by(year=2018, month=3, date=30).one()
	goodFri = Event(name="Good Friday", description='Friday for Easter', country='', city='')
	goodFriDate.events.append(goodFri)

	easterMonDate = Date.query.filter_by(year=2018, month=4, date=2).one()
	easterMon = Event(name='Easter Monday', description='The Monday during Easter', country='', city='')
	...
	xmasDay = Event(name='Christmas Day', description='Christmas is here!', country='', city='')
	xmasDayDate.events.append(xmasDay)

	boxingDayDate = Date.query.filter_by(year=2018, month=12, date=26).one()
	boxingDay = Event(name='Boxing Day', description='The day after Christmas', country='', city='')
